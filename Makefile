...
#    Updated: 2018/01/15 12:12:08 by lfabbro          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC_NM		= ft_nm.c handle32.c handle64.c handle_fat.c list.c print.c sections.c
SRC_OT		= ft_otool.c handle32.c handle64.c handle_fat.c
SRC_COMMON	= parse.c parse_struct.c swap.c
